"""AI service for Meeting Prep Agent — delegates to shared BaseAIService."""
import os
...
class MeetingPrepAIService(BaseAIService):
    def __init__(self):
        super().__init__(
...
meeting_prep_ai_service = MeetingPrepAIService()
